...
import 'package:ar_augmented_faces/models/ar_anchor.dart';
...
import 'package:ar_augmented_faces/datatypes/node_types.dart';
import 'package:ar_augmented_faces/datatypes/hittest_result_types.dart';
import 'package:ar_augmented_faces/models/ar_node.dart';
import 'package:ar_augmented_faces/models/ar_hittest_result.dart';
...
class _CloudAnchorWidgetState extends State<CloudAnchorWidget> {
  ...
  ARAnchor onAnchorDownloaded(Map<String, dynamic> serializedAnchor) {
    Map<String, Map> mapStringMap = anchorsInDownloadProgress[serializedAnchor["cloudanchorid"]] as Map<String,Map>;
    ARPlaneAnchor anchor = ARPlaneAnchor.fromJson(mapStringMap);
...
class FirebaseManager {
  ...
  void uploadAnchor(ARAnchor anchor, {required Position currentLocation}) {
